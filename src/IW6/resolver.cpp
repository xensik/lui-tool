...
std::unordered_map<opcode, std::string> resolver::opcode_map
{
    ...
    { opcode::HKS_OPCODE_CALL_C, "CALL_C" },
    ...
    { opcode::HKS_OPCODE_GETTABLE_N, "GETTABLE_N" },
    ...
    { opcode::HKS_OPCODE_SETTABLE_N, "SETTABLE_N" },
    { opcode::HKS_OPCODE_SETTABLE_N_BK, "SETTABLE_N_BK" },
    { opcode::HKS_OPCODE_SETTABLE, "SETTABLE" },
    { opcode::HKS_OPCODE_SETTABLE_BK, "SETTABLE_BK" },
    { opcode::HKS_OPCODE_TAILCALL_I, "TAILCALL_I" },
    { opcode::HKS_OPCODE_TAILCALL_C, "TAILCALL_C" },
    { opcode::HKS_OPCODE_TAILCALL_M, "TAILCALL_M" },
    ...
    { opcode::HKS_OPCODE_CALL_M, "CALL_M" },
    { opcode::HKS_OPCODE_CALL, "CALL" },
    { opcode::HKS_OPCODE_INTRINSIC_INDEX, "INTRINSIC_INDEX" },
    { opcode::HKS_OPCODE_INTRINSIC_NEWINDEX, "INTRINSIC_NEWINDEX" },
    { opcode::HKS_OPCODE_INTRINSIC_SELF, "INTRINSIC_SELF" },
    { opcode::HKS_OPCODE_INTRINSIC_INDEX_LITERAL, "INTRINSIC_INDEX_LITERAL" },
    { opcode::HKS_OPCODE_INTRINSIC_NEWINDEX_LITERAL, "INTRINSIC_NEWINDEX_LITERAL" },
    { opcode::HKS_OPCODE_INTRINSIC_SELF_LITERAL, "INTRINSIC_SELF_LITERAL" },
    ...
    { opcode::HKS_OPCODE_NEWSTRUCT, "NEWSTRUCT" },
    { opcode::HKS_OPCODE_DATA, "DATA" },
    { opcode::HKS_OPCODE_SETSLOTN, "SETSLOTN" },
    { opcode::HKS_OPCODE_SETSLOTI, "SETSLOTI" },
    { opcode::HKS_OPCODE_SETSLOT, "SETSLOT" },
    { opcode::HKS_OPCODE_SETSLOTS, "SETSLOTS" },
    { opcode::HKS_OPCODE_SETSLOTMT, "SETSLOTMT" },
    { opcode::HKS_OPCODE_CHECKTYPE, "CHECKTYPE" },
    { opcode::HKS_OPCODE_CHECKTYPES, "CHECKTYPES" },
    { opcode::HKS_OPCODE_GETSLOT, "GETSLOT" },
    { opcode::HKS_OPCODE_GETSLOTMT, "GETSLOTMT" },
    { opcode::HKS_OPCODE_SELFSLOT, "SELFSLOT" },
    { opcode::HKS_OPCODE_SELFSLOTMT, "SELFSLOTMT" },
    { opcode::HKS_OPCODE_GETFIELD_MM, "GETFIELD_MM" },
    { opcode::HKS_OPCODE_CHECKTYPE_D, "CHECKTYPE_D" },
    { opcode::HKS_OPCODE_GETSLOT_D, "GETSLOT_D" },
    { opcode::HKS_OPCODE_GETGLOBAL_MEM, "GETGLOBAL_MEM" },
    { opcode::HKS_OPCODE_DELETE, "DELETE" },
    { opcode::HKS_OPCODE_DELETE_BK, "DELETE_BK" },
};
